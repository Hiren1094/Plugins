...
class PfcvDiff{
   ...
   * $compareCharacters is true), and one of the constants PfcvDiff::UNMODIFIED (the
   * line or character is in both strings), PfcvDiff::DELETED (the line or character
   * is only in the first string), and PfcvDiff::INSERTED (the line or character is
